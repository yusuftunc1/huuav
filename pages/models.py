...
class MyAppUser( models.Model ) :
    ...
    depart = models.CharField(max_length=300, blank=True)
...
class teams(models.Model):
    ...
    teamlogo = models.CharField(blank=True, null=True, max_length=50, verbose_name='logo link')
    teamimage = models.CharField(blank=True, null=True, max_length=50, verbose_name='takım resim1 link')
    teamimage2 = models.CharField(blank=True, null=True, max_length=50, verbose_name='takım resim2 link')
    teamimage3 = models.CharField(blank=True, null=True, max_length=50, verbose_name='takım resim3 link')
